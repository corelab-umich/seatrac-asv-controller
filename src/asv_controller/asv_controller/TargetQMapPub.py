...
class TargetQMapPublisher(Node):
    def __init__(self):
        super().__init__('target_q_map_pub')
        
        # Create a publisher for the image topic
        self.publisher_ = self.create_publisher(Image, 'target_q_map', 10)
        
        # Set up the CvBridge
        self.bridge = CvBridge()
        
        # Define the path to your image
        self.image_path = '/root/images/target_q_map.png'
...
def main(args=None):
    ...
    image_publisher = TargetQMapPublisher()
