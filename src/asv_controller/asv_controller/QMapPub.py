...
class QMapPublisher(Node):
    def __init__(self):
        super().__init__('q_map_pub')
        
        # Create a publisher for the image topic
        self.publisher_ = self.create_publisher(Image, 'q_map', 10)
        
        # Set up the CvBridge
        self.bridge = CvBridge()
        
        # Define the path to your image
        self.image_path = '/root/images/q_map.png'
